...
from snapReactors.containers.templates import S83D_ActiveCore
...
snap = S83D_ActiveCore(fe, ce, ir, br, ugp, lgp, cds)
...
xsAbsPath=acePath, plotOptions=([3, 1], 1000, [0, 0], 1))
...
sTest3D = Serpent(id="s8c3_corecomp")
sTest3D.toSerpent(reactorState=coldpow, template=snap, baseFileName="s8c3_corecomp")
