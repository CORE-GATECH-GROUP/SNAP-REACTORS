...
from snapReactors.containers.templates import S82D, S8ER, S82D_RevisedGCU, S8_ActiveCoreGCU, S8_fuelassembly
...
for i in range(0, len(layers)):
    template =  S8_fuelassembly(fe, ce, config='C3_Core', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_fuelassembly_lay{}".format(layers[i]), nActiveLayers=layers[i], geo = "3D", useRefForMesh=True)
