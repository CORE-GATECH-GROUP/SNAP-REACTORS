...
from snapReactors.containers.templates import S82D, S8ER, S8_ActiveCoreGCU, S8_Griffin, S8_GriffinNRE, S8_GriffinTEST,  S8_GriffinTESTC2, S8_GriffinTESTC1, S8_GriffinTESTC3, S8_GriffinTESTC3_HomogVoid
...
# # # hisFilePath =  "/Users/isaacnaupaagui5rre/Documents/GitHub/SNAP-REACTORS/snapReactors/reactor_models/Automated Serpent Models/serpent_test.main_his0.m"
...
# elemres =  S8_ActiveCoreGCU(fe, ce, ir, br, cds, c
# onfig='C3_Elem', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s82d_ac_c3_gcu_elemres", geo = "2D")
...
#fullGriffin = S8_GriffinTESTC3(fe, ce, ir, br, ugp, lgp, cds, config='C3', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_c3_update", geo = "3D", useRefLayoutForMesh = False, nActiveLayers=9)

#fullGriffin = S8_GriffinTESTC2(fe, ce, ir, br, ugp, lgp, cds, config='C3', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_c2_update", geo = "3D", useRefLayoutForMesh = False, nActiveLayers=9)

fullGriffin = S8_GriffinTESTC1(fe, ce, ir, br, ugp, lgp, cds, config='C3', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_c1_update", geo = "3D", useRefLayoutForMesh = False, nActiveLayers=9)