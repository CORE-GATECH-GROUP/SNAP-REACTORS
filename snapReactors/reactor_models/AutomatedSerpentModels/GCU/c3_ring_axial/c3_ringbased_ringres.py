...
template =  S8_ActiveCoreGCU(fe, ce, ir, br, cds, config='C3', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_ac_c3_gcu_ringxs_ringres_lay{}".format(20), nActiveLayers=20, geo = "3D", useRefLayoutForMesh=False)
