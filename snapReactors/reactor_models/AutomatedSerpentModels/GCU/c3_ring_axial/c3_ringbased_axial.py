...
for i in range(0, len(layers)):
    template =  S8_ActiveCoreGCU(fe, ce, ir, br, cds, config='C3', xsLibrary="ENDF8", hasThermScatt=True, baseFile="s83d_ac_c3_gcu_ring_lay{}".format(layers[i]), nActiveLayers=layers[i], geo = "3D", useRefLayoutForMesh=True)
