...
from snapReactors.containers.templates import S82D_Revised
...
snap = S82D_Revised(fe, ce, ir, br, cds, config='C3',  xsLibrary="ENDF8", hasThermScatt=True)
...
snap.setSettings(geoType='2D', nps = 1E+05, nact = 200, nskip=100, 
...
sTest3D = Serpent(id="s82d_c3")
sTest3D.toSerpent(reactorState=coldpow, template=snap, baseFileName="s82d_c3")
