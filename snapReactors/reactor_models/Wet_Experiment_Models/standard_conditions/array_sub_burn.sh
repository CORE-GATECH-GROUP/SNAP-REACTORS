...
fuel_temps=(1 2 3)        # Adjust these as needed for the number of fuel temperature cases
coolant_temps=(1 2 3)     # Adjust these as needed for the number of coolant temperature cases
reflector_temps=(1 2 3)   # Adjust these as needed for the number of reflector temperature cases
burnup_steps=(1 2 3)
...
#!/bin/bash
#PBS -l select=8:ncpus=40:mpiprocs=1:mem=200gb
#PBS -N SerpentJob_${l}_${i}_${j}_${k}
...
mpirun sss2 s82d_ac_c3_gcu_ringres_${l}_${i}_${j}_${k}.main -omp 40
EOF
