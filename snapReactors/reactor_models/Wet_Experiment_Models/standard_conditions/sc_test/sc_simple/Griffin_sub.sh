...
#SBATCH --cpus-per-task=1           # 4 CPU cores per MPI process (20 ncpus / 5 mpiprocs)
...
/home/garcsamu/moose_exec/snapbench/snapbench-opt -i /home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/standard_conditions/sc_test/sc_simple/sc_core.i