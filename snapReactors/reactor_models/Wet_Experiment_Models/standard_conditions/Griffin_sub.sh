...
cd $PBS_O_WORKDIR
export TMPDIR=/tmp
mpiexec -n 20 griffin-opt -i /home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/standard_conditions/wet_core.i 
