...
# Plot 1: Cumulative Loss vs Time (days)

# ============================================================================

# ax1 = fig.add_subplot(gs[0, 0])

# ax1.set_title("Cumulative Hydrogen Loss vs Time", fontsize=12, fontweight='bold')

# ax1.set_xlabel('Time [days]')

# ax1.set_ylabel('Cumulative H Loss [pcm]')

# ax1.plot(time_days, exp_cumulative_loss, 'k-', linewidth=2.5, label='Experimental Fit', zorder=3)

# ax1.plot(time_days, model_1ring_loss, 'r--', linewidth=2, label='1-Ring Model', alpha=0.8)

# ax1.plot(time_days, model_8ring_loss, 'b--', linewidth=2, label='8-Ring Model', alpha=0.8)
...
# Plot 2: Cumulative Loss vs Burnup

# ============================================================================

ax2 = fig.add_subplot(gs[0, 1])

ax2.set_title("Cumulative Hydrogen Loss vs Burnup", fontsize=12, fontweight='bold')

ax2.set_xlabel('Burnup [MWd/kgU]')

ax2.set_ylabel('Cumulative H Loss [pcm]')

# ax2.plot(burnup_range, exp_cumulative_loss, 'k-', linewidth=2.5, label='Experimental Fit', zorder=3)

ax2.plot(burnup_range, model_1ring_loss, 'r--', linewidth=2, label='1-Ring Model', alpha=0.8)

ax2.plot(burnup_range, model_8ring_loss, 'b--', linewidth=2, label='8-Ring Model', alpha=0.8)
...
# # Plot 3: Loss Rate vs Time

# # ============================================================================

# ax3 = fig.add_subplot(gs[1, 0])

# ax3.set_title("Hydrogen Loss Rate vs Time", fontsize=12, fontweight='bold')

# ax3.set_xlabel('Time [days]')

# ax3.set_ylabel('Loss Rate [pcm/day]')

# ax3.plot(time_days, exp_loss_rate, 'k-', linewidth=2.5, label='Experimental Fit', zorder=3)

# ax3.plot(time_days, model_1ring_rate, 'r--', linewidth=2, label='1-Ring Model', alpha=0.8)

# ax3.plot(time_days, model_8ring_rate, 'b--', linewidth=2, label='8-Ring Model', alpha=0.8)
...
# # Plot 4: Loss Rate vs Burnup

# # ============================================================================

# ax4 = fig.add_subplot(gs[1, 1])

# ax4.set_title("Hydrogen Loss Rate vs Burnup", fontsize=12, fontweight='bold')

# ax4.set_xlabel('Burnup [MWd/kgU]')

# ax4.set_ylabel('Loss Rate [pcm/day]')

# ax4.plot(burnup_range, exp_loss_rate, 'k-', linewidth=2.5, label='Experimental Fit', zorder=3)

# ax4.plot(burnup_range, model_1ring_rate, 'r--', linewidth=2, label='1-Ring Model', alpha=0.8)

# ax4.plot(burnup_range, model_8ring_rate, 'b--', linewidth=2, label='8-Ring Model', alpha=0.8)
...
# # Plot 5: Difference (Model - Experimental) vs Time

# # ============================================================================

# ax5 = fig.add_subplot(gs[2, 0])

# ax5.set_title("Cumulative Loss Difference (Model - Experimental)", fontsize=12, fontweight='bold')

# ax5.set_xlabel('Time [days]')

# ax5.set_ylabel('Difference [pcm]')

# diff_1ring = model_1ring_loss - exp_cumulative_loss

# diff_8ring = model_8ring_loss - exp_cumulative_loss

# ax5.plot(time_days, diff_1ring, 'r-', linewidth=2, label='1-Ring - Exp')

# ax5.plot(time_days, diff_8ring, 'b-', linewidth=2, label='8-Ring - Exp')
...
# # Plot 6: Percent Difference

# # ============================================================================

# ax6 = fig.add_subplot(gs[2, 1])

# ax6.set_title("Percent Difference (Model - Experimental)", fontsize=12, fontweight='bold')
...
# pct_diff_1ring = np.where(exp_cumulative_loss > 10, 

#                           100 * diff_1ring / exp_cumulative_loss, 0)

# pct_diff_8ring = np.where(exp_cumulative_loss > 10, 

#                           100 * diff_8ring / exp_cumulative_loss, 0)

# ax6.plot(time_days, pct_diff_1ring, 'r-', linewidth=2, label='1-Ring - Exp')

# ax6.plot(time_days, pct_diff_8ring, 'b-', linewidth=2, label='8-Ring - Exp')
