...
def main():
    ...
    base_data_dir = '/home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/Serpent/reactivity_worths/hydrogen_diffusion/axial_diffusion_SWIFT/cladding_held'
