...
poison_worth = (poi_rho - stand_rho) * 1e5

# Propagate absolute uncertainties for the difference 
poison_worth_unc = np.sqrt(poi_rho_unc**2 + stand_rho_unc**2) * 1e5
...
print(f"NaK worth is {poison_worth:.2f} \u00B1 {poison_worth_unc:.2f} pcm (1σ)")
print(f"NaK worth is {poison_worth:.2f} \u00B1 {poison_worth_unc_3sigma:.2f} pcm (3σ)")