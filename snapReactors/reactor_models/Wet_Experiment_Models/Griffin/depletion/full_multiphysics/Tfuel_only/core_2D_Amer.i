...
[MultiApps]
    [sc]
      ...
      input_files = '/home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/Griffin/depletion/full_multiphysics/Tfuel_only/sc_core.i'
      execute_on =  timestep_end
...
[]
  ...
  [Transfers]
    [flux_to_SC]
        ...
        to_blocks = fuel_pins
        greedy_search = true
        from_postprocessors_to_be_preserved = bison_norm_power
