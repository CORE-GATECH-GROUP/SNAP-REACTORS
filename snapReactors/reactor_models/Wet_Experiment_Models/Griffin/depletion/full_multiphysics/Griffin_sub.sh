#!/bin/bash
#SBATCH --job-name=MultiPhysDep          # Job name
...
#SBATCH --time=30:45:00              # Walltime (hh:mm:ss)
...
mpiexec -n 14 griffin-opt -i /home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/Griffin/depletion/full_multiphysics/depletion_core.i --allow-unused