...
#SBATCH --time=4:45:00              # Walltime (hh:mm:ss)
...
mpiexec -n 14 griffin-opt -i /home/garcsamu/Serpent/SNAP-REACTORS-PRIVATE/snapReactors/reactor_models/Wet_Experiment_Models/Griffin/standard_conditions/griffin_standalone/wet_core.i -w